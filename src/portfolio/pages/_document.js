    ...
    return (
      <html lang="en">
        <Head>
          ...
          <link rel="shortcut icon" href={`${process.env.ASSET_PREFIX}/static/favicon.ico`} />
          ...
          <link
            rel="stylesheet"
            href={`${process.env.ASSET_PREFIX}/static/css/font-awesome.min.css`}
          />
          <link rel="stylesheet" href={`${process.env.ASSET_PREFIX}/static/css/styles.css`} />
        </Head>
        <body>
          <Main />
          <NextScript />
